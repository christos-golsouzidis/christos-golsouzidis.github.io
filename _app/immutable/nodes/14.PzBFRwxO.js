...
│       └── config.html
|
└── README.md</code>`),n(h);var y=a(h,8),E=s(y);t(E,()=>'<code class="language-env">GROQ_API_KEY=&lt;your_groq_api_key_here&gt;</code>'),n(y);var w=a(y,10),A=s(w);t(A,()=>`<code class="language-bash">python main.py <span class="token comment"># or 'python3 main.py'</span></code>`),n(w);var b=a(w,8),G=s(b);t(G,()=>`<code class="language-python"><span class="token decorator annotation punctuation">@app<span class="token punctuation">.</span>get</span><span class="token punctuation">(</span><span class="token string">"/"</span><span class="token punctuation">)</span>
...
</code>`),n(b);var x=a(b,4),R=s(x);t(R,()=>`<code class="language-python">
<span class="token keyword">class</span> <span class="token class-name">ConfigModel</span><span class="token punctuation">(</span>BaseModel<span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    <span class="token punctuation">]</span></code>`),n(x);var I=a(x,4),q=s(I);t(q,()=>`<code class="language-javascript">  <span class="token function">onMount</span><span class="token punctuation">(</span><span class="token keyword">async</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">&#123;</span>
    ...
    <span class="token punctuation">&#125;</span>
  <span class="token punctuation">&#125;</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code>`),n(I);var T=a(I,4),M=s(T);t(M,()=>`<code class="language-python"><span class="token decorator annotation punctuation">@app<span class="token punctuation">.</span>get</span><span class="token punctuation">(</span><span class="token string">"/api/init"</span><span class="token punctuation">)</span>
<span class="token keyword">async</span> <span class="token keyword">def</span> <span class="token function">get_init</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    <span class="token punctuation">&#125;</span></code>`),n(T);var _=a(T,4),O=s(_);t(O,()=>`<code class="language-svelte"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
</span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>style</span><span class="token punctuation">></span></span></code>`),n(_),L(30),C(m,u)}var H=P('<section><div class="portfolio my-8"><!> <!></div> <div class="mt-8 mb-20"><div class="portfolio"><h2>See also</h2></div> <p>See some other relevant projects:</p> <div class="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 my-8"></div></div></section>');function X(m){let u="Widiscover",e=["front end","back end","databases","external APIs"],c=[["svelte","tailwindCSS"],["python","FastAPI"],["QDrant"],["Groq Cloud API"]],i="https://github.com/christos-golsouzidis/widiscover",v=[{text:"Infrang (INFormation Retrieval and ANswer Generation)",link:"infrang"},{text:"Anti-captcha application",link:"anticaptcha"},{text:"Text recognition application",link:"textrecognition"}];var p=H(),o=s(p),k=s(o);B(k,{titleList:e,techList:c,githubLink:i,name:u});var r=a(k,2);$(r),n(o);var g=a(o,2),l=a(s(g),4);S(l,5,()=>v,F,(d,f)=>{K(d,{get items(){return N(f)}})}),n(l),n(g),n(p),C(m,p)}export{X as component};
